...
import com.xuena.supplier.mapper.MonthlyAssessmentMapper;
...
public class MonthlyAssessmentServiceImpl implements MonthlyAssessmentService {
    ...
    public MonthlyAssessmentServiceImpl(MonthlyAssessmentMapper monthlyAssessmentMapper) {
        this.monthlyAssessmentMapper = monthlyAssessmentMapper;
    }

    @Override
    public MonthlyAssessmentDO getById(Long id) {
    ...
    @Override
    @Transactional
    public MonthlyAssessmentDO update(Long id, MonthlyAssessmentDO assessment) {
