...
class CategoryServiceTest {
    ...
    void getById_NotFound_ThrowsException() {
        assertThrows(BusinessException.class, () -> categoryService.getById("999999"));
    }
    ...
    void update_NotFound_ThrowsException() {
        ...
        assertThrows(BusinessException.class, () -> categoryService.update("999999", category));
    }
    ...
    void delete_NotFound_ThrowsException() {
        assertThrows(BusinessException.class, () -> categoryService.delete("999999"));
    }
}
